...
impl Led2dGenerated {
    ...
    ///
    /// See [`Led2dGenerated`] for usage.
    pub async fn write_frame(&self, frame: crate::led2d::Frame2d<12, 4>) -> crate::Result<()> {
        let _ = frame;
        Ok(())
    }
    ...
    pub async fn animate(
        &self,
        frames: impl IntoIterator<Item = (crate::led2d::Frame2d<12, 4>, embassy_time::Duration)>,
    ) -> crate::Result<()> {
        let _ = frames;
        Ok(())
    }
    ...
    pub fn write_text_to_frame(
        ...
        frame: &mut crate::led2d::Frame2d<12, 4>,
    ) -> crate::Result<()> {
